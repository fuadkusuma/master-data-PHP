 ...
 <body style="background-color: #ffffff">  
	 <div id="container">
		<?php include "includes/header.php" ?>			
            ...
            <div class="col-md-8" style="margin-top: 50px;">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Add Guru</legend>    
                <form name="guru" action="?page=guru_add" method="post" onsubmit="return checkForm(this)">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-group" name="status_kawin" id="status_kawin" style="width: 100%;">
                                    <option value="islam">Kawin</option>​
                                    <option value="kristen">Belum Kawin</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-group" name="pendidikan_terakhir" id="pendidikan_terakhir" style="width: 100%;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-group" name="thn_lulus" id="thn_lulus" style="width: 100%;">
                                <?php
                                    $lulus=2021;
		...
		if (isset($_POST['submit']))
		{
			...
			$Guru->tambahDataGuru( $nip, $nama_guru, $jenis_kelamin, $agama, $status_kawin, $pendidikan_terakhir,  $jurusan, $thn_lulus) ;
	

			 echo "Data Guru  sudah di ditambahkan";
